...
export function kotlinProxy(kotlinInstance, goDeep=true) {
    ...
    if(typeof kotlinInstance==='function'){
    ...
    if(typeof kotlinInstance!=='object'){
        return kotlinInstance
    } else {
...
export function kotlinProxy2(kotlinInstance) {
...
export function kotlinProxyOld(kotlinInstance) {
